...
UPDATE `Grade_Year_Average` SET `yrgraGPA` = 3.5, `yryrgraRemark` = 'Exceeds Standards', `yrgraLetterGrade` = 'B+'  WHERE ROUND(`yrgraYearAverage`) >= 85 AND ROUND(`yrgraYearAverage`) < 90;
