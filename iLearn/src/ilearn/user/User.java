...
public class User
{
    ...
    public static final String administrationString = "Student-true|Add Student-true|Edit Student-true|View Student-true|Attendance-true|Enter Attendance-true|Edit Attendance-true|Grades-true|Record Grade-true|Edit Grade-true|Edit Report Card Remarks-true|Remove Grades-true|Merits-true|Record Merits-true|Edit Merits-true|Demerits-true|Record Demerits-true|Edit Demerits-true|Detention-true|Add Detention-true|Edit Detention-true|Record Served Detention-true|Reports-true|Attendance Reports-true|Attendance Summary-true|Attendance Details-true|Student Reports-true|Student List-true|Repeating Students-true|Students By Class-true|Student ID Cards-true|Class Reports-true|Class List Report-true|Class Grade Book-true|Nationality Report-true|Report Cards Menu-true|Mid Term Reports-true|Mid Term Class Ranking-true|Term End Report-true|Term End Ranking-true|Demerit Reports-true|Demerit Summary by Student-true|Demerit Summary by Teacher-true|Demerits By Class-true|Demerits By Student-true|Statistical Reports-true|Class Size Distribution-true|Gender Distribution-true|Manage-true|Class-true|Add Class-true|Edit Class-true|View Class-true|Promotions-true|Assign Promotions-true|Promote Students-true|School-true|Staff-true|Add Staff-true|Edit Staff-true|Subjects-true|Add Subjects-true|Edit Subjects-true|Term-true|Add Term-true|Edit Term-true|Time Slots-true|Add Time Slot-true|Edit Time Slot-true|User Menu-true|Add User-true|Edit User-true|Lock User-true|Unlock User-true|Utilities Menu-true|Mid Term-true|Calculate Mid Term Grades-true|Reset Grade Remarks-true|Clear Empty Grades-true|End Of Term-true|Calculate End of Term Grades-true|Close Term-true|";
    ...
    public static void getPermittedListItems()
    {
        try
        {
            permittedSubjects = new ArrayList<String>();
    ...
    public static ArrayList<String> getPermittedStaffMembers(String usrName)
    {
        ArrayList<String> permittedStaff = new ArrayList<String>();
        try
        {
            ...
            while (rs.next())
            {
                permittedStaff.add(rs.getString("Name"));
            }
            rs.close();
            prep.close();
        }
