 ...
 * @author mrogers
 */
public class FrmEditDemerit extends javax.swing.JInternalFrame
{

    static final Logger logger = Logger.getLogger(FrmEditDemerit.class.getName());
    String warnings = "";

    /** Creates new form FrmRecordDemeritStudent */
    public FrmEditDemerit()
    {
        initComponents();
        populateLists();
    }
    ...
    private void initComponents()
    {
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance().getContext().getActionMap(FrmEditDemerit.class, this);
...
//GEN-HEADEREND:event_tblSearchMouseClicked
    ...
    public void save()
    {
        ...
        {
            String message = "An error occurred while trying to update this demerit.\n"
