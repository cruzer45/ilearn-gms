...
public class ILearnView extends FrameView
{
    ...
    public void showRecordDemerits()
    {
        ...
        if (AlreadyLoaded == false)
        {
            ...
            desktopPane.add(frmRecordDemeritStudent);
            //Load the Form
            frmRecordDemeritStudent.setVisible(true);
            frmRecordDemeritStudent.show();
            try
            {
                frmRecordDemeritStudent.setIcon(false);
                frmRecordDemeritStudent.setSelected(true);
            }
            catch (Exception e)
            {
                logger.log(Level.SEVERE, "Error displaying the form.", e);
    ...
    private javax.swing.JMenuItem calculateMidTerm;
    ...
    private javax.swing.JMenuItem editMidTerms;
    ...
    private javax.swing.JMenuItem manageSchool;
    ...
    private javax.swing.JMenuItem recordDemerits;
    ...
    private javax.swing.JMenuItem studentIDCards;
    private javax.swing.JMenuItem studentList;
    private javax.swing.JMenuItem studentListByClass;
