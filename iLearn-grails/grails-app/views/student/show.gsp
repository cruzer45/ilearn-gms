			...
			<g:if test="${studentInstance?.photo}">
				<li class="fieldcontain"><span id="photo-label"
					class="property-label"> <g:message
						...
						<img src="${createLink(controller:'student',action:'displayPhoto', id:studentInstance?.id)}" />
				</span></li>
			</g:if>
			
				<g:if test="${studentInstance?.socialSecurityNumber}">
				<li class="fieldcontain">
					<span id="socialSecurityNumber-label" class="property-label"><g:message code="student.socialSecurityNumber.label" default="Social Security Number" /></span>
					
						<span class="property-value" aria-labelledby="socialSecurityNumber-label"><g:fieldValue bean="${studentInstance}" field="socialSecurityNumber"/></span>
				...
				<li class="fieldcontain">
					<span id="otherNames-label" class="property-label"><g:message code="student.otherNames.label" default="Other Names" /></span>
					
						<span class="property-value" aria-labelledby="otherNames-label"><g:fieldValue bean="${studentInstance}" field="otherNames"/></span>
				...
				<li class="fieldcontain">
					<span id="classCode-label" class="property-label"><g:message code="student.classCode.label" default="Class Code" /></span>
					
						<span class="property-value" aria-labelledby="classCode-label"><g:fieldValue bean="${studentInstance}" field="classCode"/></span>
